...
ifelse(abs(Z) < Z_critical, 
       "Computed Z score is less than critical value, we reject the null hypothesis.",
       "Computed Z score is greater than or equal to critical value, we fail to reject the null hypothesis.")

# 9. Conclusion -----------------------------------------------------------

print("We cannot conclude that the mean baseline systolic blood pressure of our data is less than historical benchmark of 140 mmHg")

# 10. p value -------------------------------------------------------------

p <- pnorm(abs(Z), lower.tail = T)  ; round(p,3)
